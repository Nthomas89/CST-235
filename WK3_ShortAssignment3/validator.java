...
public class validator implements Serializable {
    ...
    public void doValid() {
    	...
    	if(allValid){
    	String csvFile = "/Users/Nthom/Desktop/creditCards.csv";
        String line = "";
        String cvsSplitBy = ",";
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(csvFile))) {
            ...
            if(Valid){
            	setCardPass("The Credit Card entered is valid");
            	setCardFail("");
            } else { setCardPass("");
            		 setCardFail("The Credit Card you entered does not match our records."); 
            		 }
	...
	private boolean checkAllFileds() {
        ...
        // Setup to include numbers, letters, and hyphens
     ...
     //  card number
        if (cardNumber.equals("")) {
        	...
        	cardNumberFail = "Please check credit card number";
        } else{cardNumberFail = "";}
